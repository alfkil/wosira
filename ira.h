...
#define BETA        1
#if BETA == 0
  #define IDSTRING1   ("\nWOSIRA V%s.%s "__AMIGADATE__"\n" \
                       "IRA: (c)1993-95 Tim Ruehsen (SiliconSurfer/PHANTASM)\n" \
                       "     (c)2009 Frank Wille\n" \
					   "VDAPPC: (c)1998-2001,2009  Frank Wille\n" \
						"WOSIRA: (c)2011 Alfkil Wennermark\n\n")
  #define IDSTRING2   ("; WOSIRA V%s.%s "__AMIGADATE__" (c)1993-95 Tim Ruehsen, (c)1998-2001,2009 Frank Wille, (c)2011 Alfkil Wennermark\n\n")
#else
  #define IDSTRING1   ("\nWOSIRA V%s.%sbeta "__AMIGADATE__"\n" \
                       "IRA: (c)1993-95 Tim Ruehsen (SiliconSurfer/PHANTASM)\n" \
                       "     (c)2009 Frank Wille\n" \
					   "VDAPPC: (c)1998-2001,2009 Frank Wille\n" \
					   "WOSIRA: (c)2011 Alfkil Wennermark\n\n")
  #define IDSTRING2   ("; WOSIRA V%s.%sbeta "__AMIGADATE__" (c)1993-95 Tim Ruehsen, (c)1998-2001,2009 Frank Wille, (c)2011 Alfkil Wennermark\n\n")
#endif
